...
namespace RecursionPlayground
{
    internal class Program
    {
        ...
        static int Factorial(int n)
        {
            ...
            return n == 1 ? n : Factorial(n - 1) * n; // TODO: Uprav, aby Factorial vracel spravnou hodnotu.
        }

        static int Fibonacci(int n)
        {
            // TODO: Urci ukoncovaci podminku pro Fibonacciho a zavolej Fibonacci zevnitr se spravnym parametrem / vypoctem.
            return n < 2 ? n : n == 2 ? 1 :Fibonacci(n - 1) + Fibonacci(n - 2); // TODO: Uprav, aby Fibonacci vracel spravnou hodnotu.
        }
    }
}
